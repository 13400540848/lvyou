...
public class AdminLoginedArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterAnnotation(AdminLogined.class) != null &&
                //如果该参数的类型为User
...
//        }
        ...
        return (IUser) request.getSession().getAttribute(IUser.LOGIN_ADMIN_USER);
//        return null;
    }
}