...
(function ($) {
        ...
        $.each(this.header.fields, function(j, field) {
            ...
            if (column.checkbox || column.radio) {
                ...
                text = that.options.cardView ? ['<div class="card-view">',
                    ...
                    '</div>'
                ].join('') : [sprintf('<td%s %s %s %s %s %s %s %s>',
                        id_, class_, style, data_, rowspan_, colspan_, title_, html_title_),
                    value,
                    '</td>'
                ].join('');
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(this.columns, function (i, column) {
            ...
            html.push('<td dddd="tttttttt" ', class_, sprintf(' style="%s"', falign + valign + csses.concat().join('; ')), '>');
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.pagination && this.options.sidePagination === 'server') {
            ...
            fixedScroll = data || data.fixedScroll;
            data = data[this.options.dataField];
        } else if (!$.isArray(data)) { // support fixedScroll
            fixedScroll = data ? data.fixedScroll : null;
